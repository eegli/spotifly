...
/**
 * Generic convenience method that allows freestyle requests which
 * include an access token. Can be used to call new Spotify endpoints
 * that are not yet supported by this library.
 *
 */
