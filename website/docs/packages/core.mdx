...
<details>
  ...
  <ul>
    ...
    <li>
      <b>Episodes</b>
      <ul>
        <li>Episodes.checkAllUsersSavedEpisodes</li>
        <li>Episodes.checkUsersSavedEpisodes</li>
        <li>Episodes.getAllEpisodes</li>
        <li>Episodes.getAllUsersSavedEpisodes</li>
        <li>Episodes.getEpisode</li>
        <li>Episodes.getSeveralEpisodes</li>
        <li>Episodes.getUsersSavedEpisodes</li>
        <li>Episodes.removeAllUsersSavedEpisodes</li>
        <li>Episodes.removeUsersSavedEpisodes</li>
        <li>Episodes.saveAllEpisodesForUser</li>
        <li>Episodes.saveEpisodesForUser</li>
      </ul>
    </li>
    <li>
      <b>Genres</b>
